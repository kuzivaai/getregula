...
This is `docs/TRUST.md` rule 2 — one variable at a time —
...
This result does not support expanding the fixture count as a substitute for
real-world evaluation. The observed misses must be separated into rule misses,
context gates and label disagreements before choosing detector work.
