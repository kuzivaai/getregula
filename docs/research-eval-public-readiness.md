...
1. `/home/USER/getregula/docs/competitor-analysis.md`
2. `/home/USER/getregula/docs/moat-research.md`
3. `/home/USER/getregula/docs/research-eval-report.md`
4. `/home/USER/getregula/docs/translation-skill-recommendation.md`
5. `/home/USER/getregula/docs/what-regula-does-not-do.md`
6. `/home/USER/getregula/docs/evidence-pack-guide.md`
7. `/home/USER/getregula/content/regulations/delta-log/entries/*.json` (5 files)
8. `/home/USER/getregula/content/regulations/sandbox-registry/index.json` (27 MS entries, 5 seeded)
