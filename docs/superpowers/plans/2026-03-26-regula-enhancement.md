...
Run: `cd /home/USER/getregula && python3 tests/test_classification.py 2>&1 | tail -5`
...
Run: `cd /home/USER/getregula && python3 scripts/cli.py deps --project .`
...
Run: `cd /home/USER/getregula && python3 tests/test_classification.py 2>&1 | tail -10`
...
- [ ] **Run full test suite**: `cd /home/USER/getregula && python3 tests/test_classification.py`
