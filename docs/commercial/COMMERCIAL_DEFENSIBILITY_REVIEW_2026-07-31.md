...
`140bdacdcbfaaa9bd0892989861751b0b5e2d8d0`, Regula 1.9.0, Python 3.12.3,
Linux 6.6.87.2-microsoft-standard-WSL2. Preregistration commit: `f77473d`.
Protocol SHA-256:
...
Before results, `e7bb6d5` fixed the verifier's conflation of the mutable
...
was retained and `f9e671e` added a class-wide case-insensitive runtime
...
made `/home/USER/.regula/audit` unwritable; the exact unrestricted control
