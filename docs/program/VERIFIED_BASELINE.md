...
| HEAD commit | `27731d811e89dd5ac3180ea47009ff46fd6594f9` | `git rev-parse HEAD` |
| HEAD author/date | `github-actions[bot]`, 2026-07-13 11:06:54 +0000, "chore: weekly metrics [skip ci]" | `git log` |
| Last human commit | `fd1cd363…` Kuziva Muzondo, 2026-07-10 | `git log` |
...
| Tag `v1.7.4` → commit | `2da99223f5a0cf7b62f7854ec8052f17f65c94be` | `git rev-list -n1 v1.7.4` |
| Floating `v1` → commit | `4d02bb408c2d083226d534e37109bdcc443899b9` | `git rev-list -n1 v1` |
...
## Verification suite result (at 27731d8, Python 3.11.8) — reproduced
