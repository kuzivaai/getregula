...
All entries verified against commit `cf170c663422277c6d0f7e6e1d53d299736daa45`
...
evidence:
  ...
  external_sources: []
verified_against_commit: cf170c6
...
verified_against_commit: cf170c6
verified_at: 2026-07-13
limitations: "1.7.4 uploaded 2026-07-06; tag v1.7.4 -> 47cbfb0; HEAD is 14 commits ahead. Wheel sha256 recorded in VERIFIED_BASELINE."
```
...
evidence:
  ...
  external_sources: ["https://pypi.org/pypi/regula-ai/json"]
  test_results:
    - "collect-only @ cf170c6 = 2519"
    - "full run @ cf170c6 = 2488 passed + 32 skipped = 2520 collected"
