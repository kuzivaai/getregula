...
**Date:** 2026-07-30
**Measured at:** `9e6b6de`, tree `8e9e483` for the original investigation;
`da728db` for the corrected enumeration and the held draft.
...
The corrected predicate, at `da728db`, which asks for a proportional claim
...
- Every tracked occurrence of a `70%` figure: **16 files at `da728db`**, of
...
`da728db`: 29 entries, 21 live, 8 silent. Leaving the entries would leave four
