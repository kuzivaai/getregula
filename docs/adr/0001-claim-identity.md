...
- **Decided at:** commit b310821, branch improvement/2026-08-programme
...
inherits every unsourced claim already in it. At b310821 that produces 278
...
`scripts/claim_diff.py --base main` at b310821 in the main tree.
...
is not: 223 of 278 findings at b310821 are branch-introduced, so the condition
