...
| Version | 1.7.5 (this doc updated 2026-07-16) |
...
- 2,686 pytest-collected tests (2,686 [unique](tests/) test IDs as of 2026-07-16)
...
This model card describes Regula v1.7.5. If the detection patterns, classification logic, or evaluation methodology change, this document should be updated in the same commit.
