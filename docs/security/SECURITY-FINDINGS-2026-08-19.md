...
| CodeQL, default branch | 43 open alerts | 43 open at merge commit `8ab4e90` | PR results are baseline-relative and did not mean the repository inventory was empty |
