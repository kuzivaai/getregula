...
- Audited starting head: `20de3102240b16eb2dbf0fe589036b1c8e5249f5`
- Security reconciliation implementation commit: `08e336e`
- Default-branch CodeQL analysis commit:
  `38120bbdbecad1b9f78ad5af94c7ad8d2b0fc8e7`
- Default-branch analysis id: `1643330145`, completed
  `2026-08-19T19:49:29Z`
- Release PR 57 final head: `02d0ef02aa65e7332722990e8d650af4c269713e`
- Release PR 57 merge commit:
  `fe1f5e72702339bcea550ff17b813bb0a8bc5aac`
...
[audited starting tree](https://github.com/kuzivaai/getregula/tree/20de3102240b16eb2dbf0fe589036b1c8e5249f5)
...
`fe1f5e72702339bcea550ff17b813bb0a8bc5aac`. On 2026-08-22 each alert was
...
2. Bandit reported 0 findings. The locked all-extras dependency audit reported
   ...
   in [`uv.lock`](../../uv.lock).
3. Exact PR 57 head `02d0ef02` passed CodeQL and every required remote check in
   [PR 57](https://github.com/kuzivaai/getregula/pull/57).
4. After merge, terminal default-branch analysis `1646686319` completed at
   `fe1f5e7`; all 41 results were reviewed and dispositioned per alert. The
