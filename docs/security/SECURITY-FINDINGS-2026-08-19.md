...
- Release PR 57 final head: `825d24e30664facf3de38da277752313624449af`
- Release PR 57 merge commit:
  `1be502f913c84cbbbed85334a2c0b763f4dba829`
...
`1be502f913c84cbbbed85334a2c0b763f4dba829`. On 2026-08-22 each alert was
...
2. Bandit reported 0 findings. The locked all-extras dependency audit reported
   ...
   in [`uv.lock`](../../uv.lock).
3. Exact PR 57 head `825d24e3` passed CodeQL and every required remote check in
   [PR 57](https://github.com/kuzivaai/getregula/pull/57).
4. After merge, terminal default-branch analysis `1646686319` completed at
   `1be502f`; all 41 results were reviewed and dispositioned per alert. The
