...
from `git ls-remote --heads origin`). **`main` untouched** at `6daacd2d`,
...
1. ~~1.5c, three defects~~ **DONE** (`c7c0ae9`, `88d45f7`, `bb98261`, `f51af33`).
2. ~~Class 1 landing-page derivation~~ **DONE** (`df7ccbd`, `dc3359e`).
...
MEASURED by worktree bisect on the single test: `47cc636` **passed**,
`9f9d876` **failed**, `c3ce46c` **failed**. `9f9d876` expanded the high-risk
