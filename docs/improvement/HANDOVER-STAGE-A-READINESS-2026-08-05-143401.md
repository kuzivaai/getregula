...
Workspace `/home/mkuziva/getregula`; workspace-write sandbox; restricted network;
...
Initial HEAD `ac9e01be50fa589fa136875897643c9cd9557d0f`, tree
`de4cd0fc15213d3f49327b80c872e6645681316c`, clean worktree. `c11a831`
existed and contained the prior launch pack.

## 4. Unsettled-claim reconciliation

The count failure reproduced at current pre-fix HEAD and untouched `ba673b2`.
...
Commit `bd189da` introduced the class. Reviewer findings then produced the final
class-wide correction in implementation commit
`95caef48fa486167632276bf5e910f24988ecb14`, tree
