...
| ruff F821 on `benchmarks/synthetic/fixtures/` | 21 findings — **intentional**: fixtures are deliberately non-runnable samples of risky code; pre-existing (commit `031a6c9`) | MEASURED |
