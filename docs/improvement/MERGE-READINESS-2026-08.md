...
**Written 2026-08-17.** Measured at `1272f978960c1afd275cef6050e704442e5eb3ba`,
...
repaired in `e8139b7`, so `27_sitemap` is rc=0 at the session tip; the row is left
reading rc=1 because it is the measurement at `1272f97` and that is what the
commit range was assessed at. And `f7f146d` added seven tests, so the collected
count moved by seven from 2,960 and the runner count by seven from 1,285. **The
`2960 passed` line in section 3 is the run at `1272f97` and is correct at that
...
current count in it *creates* the violation. The full suite at `0d721b2` failed on
...
`7f8f0a3e` and **was not true at the branch tip when it was written.** Two
commits landed after that measurement, and one of them, `c7b7e05`, introduced a
...
```
9c685d5  2026-08-14  feat(site): engagement fixes from the 91-day analytics analysis
         13 files changed, 60 insertions(+), 122 deletions(-)
3f52501  2026-08-14  fix(site): raise CTA button contrast to meet WCAG AA
         9 files changed, 9 insertions(+), 9 deletions(-)
4f343bf  2026-08-14  docs(brain): add BRAIN-FEED.md, the five-line status block the ops repo reads
         1 file changed, 28 insertions(+)
b3163e4  2026-08-14  feat(site): share one questionnaire flow across the three assess locales
         10 files changed, 956 insertions(+), 975 deletions(-)
acba619  2026-08-14  fix(site): verify quoted law, make the claim guards locale-aware, cascade the count
         64 files changed, 856 insertions(+), 198 deletions(-)
6588377  2026-08-14  chore(surfaces): regenerate the derived contract for the new assess-flow asset
         2 files changed, 19 insertions(+), 7 deletions(-)
582d0f0  2026-08-14  docs(ledger): record N107, the monolingual and markup-blind claim guards
         1 file changed, 78 insertions(+)
4de7541  2026-08-14  fix(docs): published CLI transcripts asserted conclusions the tool does not make
         32 files changed, 968 insertions(+), 167 deletions(-)
7df7306  2026-08-14  chore(quarantine): burn down six entries the transcript corrections removed
         2 files changed, 130 insertions(+), 37 deletions(-)
0d579cd  2026-08-14  docs(brain): refresh the feed for the transcript-integrity workstream
         1 file changed, 1 insertion(+), 1 deletion(-)
4a579f9  2026-08-15  fix(metrics): a tracked artefact recorded cumulative totals as weekly ones
         17 files changed, 643 insertions(+), 84 deletions(-)
33fa2a1  2026-08-15  docs(brain): refresh the feed for the metrics-integrity finding
         1 file changed, 2 insertions(+), 2 deletions(-)
9ed56ec  2026-08-15  feat(site): published pricing, a sourced comparison table, and three integrity fixes
         37 files changed, 1549 insertions(+), 262 deletions(-)
da726aa  2026-08-15  fix(counts): land the README and SECURITY cascade omitted from 9ed56ec
         2 files changed, 3 insertions(+), 3 deletions(-)
3ce7d3c  2026-08-15  docs(errata): record two commits whose messages named files they do not contain
         1 file changed, 64 insertions(+)
7a7a4c2  2026-08-15  fix(pricing): reduce published prices to sit inside the measured market
         1 file changed, 4 insertions(+), 4 deletions(-)
ea64ffe  2026-08-15  fix(site): the site published two different prices, and now a guard compares them
         15 files changed, 97 insertions(+), 35 deletions(-)
e522169  2026-08-17  chore(custody): commit the 15 August working tree, verified green and unsplittable
         89 files changed, 3364 insertions(+), 352 deletions(-)
38d1ba3  2026-08-17  fix(claims): no output or key may assert a compliance state, and the class was eleven sites
         32 files changed, 1079 insertions(+), 91 deletions(-)
3a26869  2026-08-17  docs(ledger): close N125, and record six findings from the 17 August session
         2 files changed, 395 insertions(+), 3 deletions(-)
670927a  2026-08-17  fix(regulatory): South Africa had three withdrawal dates and the operative one was recorded nowhere
         20 files changed, 327 insertions(+), 70 deletions(-)
fcbef77  2026-08-17  docs(ledger): close N127 with the researched three-event timeline, record N134
         1 file changed, 175 insertions(+), 1 deletion(-)
537d37b  2026-08-17  docs(brain): record the resolved South African withdrawal timeline in the feed
         1 file changed, 1 insertion(+), 1 deletion(-)
ff576af  2026-08-17  fix(claims): the front page published a transcript no instrument could read, and the class was five carriers
         40 files changed, 1787 insertions(+), 264 deletions(-)
ac2c290  2026-08-17  refactor(fixtures): sample_compliant asserted the one thing this project does not determine
         9 files changed, 29 insertions(+), 29 deletions(-)
1272f97  2026-08-17  docs(ledger,research): close N130, N131 and N133, record N135 to N142, and land the research that was not done
...
commit before = 1272f97   tree before = 2c8b99b
commit after  = 1272f97   tree after  = 2c8b99b
```
...
- **Pricing goes live.** `site/pricing.html` carries GBP 950 for a fixed-scope
  starter assessment and GBP 650 per day for advisory work (`7a7a4c2`,
  `ea64ffe`). `PAYMENT_GATE` is `NOT_ACTIVE` and no payment path is wired, so
  these are published prices with no way to pay them.
- **The README's only visual was removed** (`ff576af`) and replaced by a fenced
...
different reason. The sentence above is left as the measurement at `cdfaf18`.
...
`cdfaf18`, tree `0fa38947d118716dabcc8ae36702da10368e6022`.
...
3f52501 ...@{2026-08-14 09:25:49 +0100}: update by push

$ git rev-list --count main..3f52501     -> 2
$ git rev-list --count 3f52501..HEAD     -> 38
```
...
Re-derived at `c7b7e05` **before any work started**, which is why it was found
...
All three were one cause: `BRAIN-FEED.md:15`, a sentence added by `c7b7e05`
...
was measured at `7f8f0a3e`, two commits earlier. **Nothing said the figures
...
Run at `5cd0b02` with a clean working tree, each exit code written to a file in
...
**The re-run earned its keep at the commit before this one.** At `6a5f956`, two
