# Direct-transaction discovery owner launch gate
...
| Decision | Status | Required before contact |
|---|---|---|
| Identify the controller and authorised research lead | OWNER_INPUT_REQUIRED; PROFESSIONAL_REVIEW_REQUIRED | Yes |
| Approve the narrow research purpose | OWNER_INPUT_REQUIRED | Yes |
...
The recommended reversible configuration is Stage A with no recording,
transcription, documents, repositories, confidential material, incentives or
Regula demonstration. It still requires the decisions above.

## Gate

PROCEED only after every required decision is recorded, participant information
is populated and professionally reviewed where required, storage is tested, and
the owner explicitly authorises contact. HOLD while any prerequisite is open.
KILL if compliant contact cannot occur, transaction-qualified access fails,
