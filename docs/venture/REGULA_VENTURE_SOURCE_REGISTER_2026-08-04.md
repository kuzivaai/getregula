...
|---|---|---|---|---|
| R01 | `README.md`, `SECURITY.md`, `docs/TRUST.md`, `docs/MODEL_CARD.md`, `docs/architecture.md` | checkout `a62e8aa`, tree `8cd9697` | `REPOSITORY_MEASURED`: product boundary, architecture, security and language depth | Later than frozen commercial product commit; internal evidence only |
...
| R03 | `benchmarks/commercial_v1/results/summary.json` and raw score | frozen product `94efa9e`; protocol commit `5bd2112`; session 2026-07-31 | `REPRODUCED`: A/B local 0/40; baselines 40/40; zero labelled repositories; STOP | Constructed correlated transformations; version-bound; no external accuracy |
...
| R06 | `site/pricing.html` | checkout `a62e8aa` | Paid tiers marked coming soon; no payment accepted | Public claim, not demand evidence |
