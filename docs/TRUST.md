...
| 2,684 unique tests (2,684 pytest-collected), 6 self-tests, 0 known security findings | see [§3](#3-reproducibility) |
...
# Expected: 2684 passed (~15 minutes on a laptop — verified 2026-07-16)
...
| Test suite | `tests/` (2,684 unique tests, 2,684 pytest-collected; the legacy `tests/test_classification.py` runner executes 922 functions, 437 defined in-file) |
