...
| 1,927 unique tests (2,318 pytest-collected), 6 self-tests, 0 known security findings | see [§3](#3-reproducibility) |
...
### 3.1 Internal test suite — 1,927 unique / 2,318 pytest-collected, all green

```bash
git clone https://github.com/kuzivaai/getregula.git
cd getregula
python3 -m pytest tests/ -q
# Expected: 2318 passed (~12 minutes on a laptop — verified 2026-06-11)
# 1,927 unique tests; 398 are duplicated via globals() import binding
...
| Test suite | `tests/` (1,927 unique tests, 2,318 pytest-collected; 834 functions in the legacy `tests/test_classification.py` custom runner) |
...
| Test suite | `tests/` | 1,927 unique tests (2,318 pytest-collected) |
