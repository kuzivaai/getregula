...
| Test suite | `tests/` (2,692 unique tests, 2,692 pytest-collected; the legacy `tests/test_classification.py` runner executes 1,088 functions, 440 defined in-file) |
