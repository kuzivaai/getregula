...
| Test suite | `tests/` (2,729 unique tests, 2,729 pytest-collected; the legacy `tests/test_classification.py` runner executes 1,097 functions, 440 defined in-file) |
