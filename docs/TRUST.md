...
| 2,531 unique tests (2,531 pytest-collected), 6 self-tests, 0 known security findings | see [§3](#3-reproducibility) |
...
### 3.1 Internal test suite — 2,531 [unique](../tests/) / 2,531 pytest-collected, all green
...
| Test suite | `tests/` (2,531 unique tests, 2,531 pytest-collected; the legacy `tests/test_classification.py` runner executes 888 functions, 437 defined in-file) |
...
| Test suite | `tests/` | 2,531 unique tests (2,531 pytest-collected) |
