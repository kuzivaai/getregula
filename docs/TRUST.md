...
The runner currently discovers 1,263 functions, a count machine-checked by
...
| Test suite | `tests/` (2,922 unique tests, 2,922 pytest-collected; the legacy `tests/test_classification.py` runner executes 1,263 functions, 442 defined in-file) |
