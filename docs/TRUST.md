...
| 2,439 unique tests (2,439 pytest-collected), 6 self-tests, 0 known security findings | see [§3](#3-reproducibility) |
...
### 3.1 Internal test suite — 2,439 [unique](../tests/) / 2,439 pytest-collected, all green

```bash
git clone https://github.com/kuzivaai/getregula.git
cd getregula
python3 -m pytest tests/ -q
# Expected: 2439 passed (17m08s measured on a laptop, verified 2026-07-29)
# 2,439 unique tests (sort -u of test IDs equals collected count).
```
...
| Test suite | `tests/` (2,439 unique tests, 2,439 pytest-collected; the legacy `tests/test_classification.py` runner executes 963 functions, 437 defined in-file) |
...
| Test suite | `tests/` | 2,439 unique tests (2,439 pytest-collected) |
