...
one exists, task-critical links need a visible language cue.
"""
import html
import re
import subprocess
...
class TestLocaleLinkLanguage(unittest.TestCase):
    ...
    # task failure rather than a mild surprise: the pricing page and the
    ...
    def test_the_body_calls_to_action_carry_a_visible_cue(self):
        ...
        A German reader clicking through to the pricing page cannot see
