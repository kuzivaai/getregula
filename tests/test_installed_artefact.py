...
Ledger N144: `regula-ai` 1.9.0 on PyPI prints a compliance score out of 100, a
...
Ledger N146's sibling in packaging: v1.7.6 shipped `regula dpv` broken because a
...
def test_the_artefact_scan_excludes_only_the_guards_own_source():
    ...
    # A repository-only exclusion must NOT be honoured inside an artefact.
    assert dg.in_scope("docs/improvement/LEDGER.md") is False
    assert dg.artefact_in_scope("docs/improvement/LEDGER.md") is True
