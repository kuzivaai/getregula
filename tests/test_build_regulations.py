...
def test_build_regulations_render_region_produces_valid_html():
    ...
    # the rest of the decorative sweep, and this assertion went
    # with it. The nav's route to the pricing page replaces it, because the
    ...
    # before that sweep, and a regenerated page must not lose it.
