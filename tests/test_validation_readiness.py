...
def test_readiness_mutation_controls() -> None:
    mutations = (
        ...
        ("01-TRUTH-AND-DEPENDENCIES.md", "Kuziva originated and built the initial Regula project.", "Phuluso originated and built the initial Regula project.", "01-TRUTH-AND-DEPENDENCIES.md: missing control: founder-history boundary"),
    )
