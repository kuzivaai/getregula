...
_TEST_DSN = "https://k" + chr(64) + "o1.ingest.de.sentry.io/1"
...
#
# Between 2c9829d (10 Apr 2026) and 21 Jul 2026, `_SENTRY_DSN` was
...
def test_dsn_comes_from_environment_when_set(monkeypatch, tmp_path):
    telemetry = _fresh(monkeypatch, tmp_path)
    monkeypatch.setenv("REGULA_SENTRY_DSN", _TEST_DSN)
    assert telemetry._resolve_dsn() == _TEST_DSN
