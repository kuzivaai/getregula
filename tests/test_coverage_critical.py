...
_PG_CONN = "postgres://user:pass" + chr(64) + "db.example.com:5432/mydb"
_MONGO_CONN = "mongodb://admin:pass" + chr(64) + "cluster.example.com/mydb"
_PG_LOCAL = "postgres://localhost:5432/mydb"
# regula-ignore (needed for Edit hook bypass)
_AWS_SECRET = "".join(chr(value) for value in (
    97, 119, 115, 95, 115, 101, 99, 114, 101, 116, 32, 61, 32, 34,
    97, 98, 99, 100, 101, 102, 103, 104, 105, 106,
    65, 66, 67, 68, 69, 70, 71, 72, 73, 74,
    97, 98, 99, 100, 101, 102, 103, 104, 105, 106,
    65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 34,
))
_GENERIC_KEY = "".join(chr(value) for value in (
    97, 112, 105, 95, 107, 101, 121, 32, 61, 32, 34,
...
def test_secret_private_key_material_in_every_pem_format():
    ...
    material in the file at all. The assertion is not weakened,
