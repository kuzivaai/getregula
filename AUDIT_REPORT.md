...
The `regula docs` command regenerated this file during the session. It contains machine-specific paths (`/home/USER/getregula`) and timestamps. It should either be .gitignored or generated on demand, not committed.
