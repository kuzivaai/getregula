...
**Status:** DONE — Session 1 (commit 22c8a73 et seq.)
...
**Status:** PARTIAL — Session 4 (commits ef2175d, 24bbdf7, 7b95d78). Protocol documented, blind subset generated, compute_kappa.py built. Labelling itself is human-gated (HUMAN_ACTIONS §9).
...
**Status:** PARTIAL — Session 4 (commit f34f0f9). 39 candidates harvested from 7 repos. Labelling is human-gated (HUMAN_ACTIONS §9).
...
**Status:** DONE — Session 4 (commit 49a6f78). `regula report --format exec-summary` produces print-optimised HTML. Art 6 disclaimer and non-conformity footer included.
...
**Status:** DONE — Session 7 (commit 59c9f9f). 12 clauses mapped, 7 with indicator/evidence coverage. Based on secondary sources (caveat documented). Revision needed when standards publish (Q4 2026).
...
**Status:** DONE — Session 7 (commit 59c9f9f). 7 clause groups, 16/17 AI_SECURITY categories mapped. Based on secondary sources (caveat documented). Revision needed when standards publish (Q4 2026).
