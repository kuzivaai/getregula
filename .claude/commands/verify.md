...
This sequence mirrors the CI workflow in `.github/workflows/ci.yaml` exactly. If /verify is green locally, CI should be green too. If you skip step 2, you risk shipping changes that pass the custom runner but fail in CI — that exact gap shipped commit a224692 in this session.
