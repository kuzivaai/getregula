...
""",
        },
        {
            ...
            "body": """
<p>Regula is an open-source static analysis tool that scans code for AI governance risk indicators. It was built primarily against the EU AI Act, but every finding is also mapped to UK DSIT / ICO principles (among twelve other frameworks). For a UK team the practically useful starting commands are:</p>
