...
> Static analysis CLI that scans your codebase for EU AI Act risk indicators. 398 detection patterns, 8 programming languages, 12 compliance framework mappings. Zero dependencies, fully offline. Classifies your risk tier and tells you what to fix. Free.
...
Regula is the tool behind that analysis: a Python CLI that scans codebases for 398 regex-based patterns mapped to EU AI Act articles. Eight language families, zero dependencies, fully offline. It classifies your risk tier and generates compliance artefacts (gap assessments, Annex IV doc scaffolds, evidence packs).
...
**Key Features:**
1. **Risk tier classification** -- Scans codebases against 398 detection patterns mapped to EU AI Act articles, identifying prohibited practices (Art. 5), high-risk categories (Annex III), limited-risk transparency obligations, and GPAI usage.
