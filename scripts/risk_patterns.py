...
HIGH_RISK_PATTERNS = {
    ...
    "critical_infrastructure": {
        ...
        "patterns": [r"\benergy.?grid", r"\bwater.?supply", r"\btraffic.?control",
                     ...
                     r"\b(?:gas|natural[_\W]?gas)[_\W]?(?:pressure|flow|leak|monitor|dispatch|scada|control)",
                     r"\b(?:gas|oil)[_\W]?pipeline[_\W]?(?:pressure|flow|leak|monitor|dispatch|scada|control)",
                     r"\bpipeline[_\W]?(?:pressure|flow|leak|monitor|dispatch|scada)(?!net\b)",
