...
def main(argv: list[str]) -> int:
    from tracked_inputs import untracked_inputs
    ...
    # is here because a guard on only one generator would close an instance
    # rather than the class of reproducibility failures.
    from tracked_inputs import UntrackedInputError, assert_inputs_tracked
    try:
