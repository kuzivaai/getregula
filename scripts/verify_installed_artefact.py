...
Ledger N144 is the entry that exists because nothing checked this. `regula-ai`
...
def _package_data(pyproject: Path | None = None) -> dict[str, list[str]]:
    ...
    Restating the config in a test is the drift `.claude/rules/quality-standards.md`
