...
declared four commits and a finish at `8c2fccb`. Six commits appeared in its
own itemisation. But `git rev-list --count 2c1f080..8c2fccb` is 4, so the
count was internally consistent with its own declared finish. The defect was
that the **declared finish commit was stale**: `4a442f2` and `e9c1e03`
