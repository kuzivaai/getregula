...
<h2>Methodology</h2>
<p style="font-size:0.9rem;">Regula v{VERSION}, {_pattern_count()} detection patterns across 8 language families. Benchmark: 83.5% precision on production code (N=115, measured on v1.7.0). Full methodology: <a href="https://github.com/kuzivaai/getregula/blob/main/docs/TRUST.md">TRUST.md</a></p>
