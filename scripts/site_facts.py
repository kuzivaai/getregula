...
Counts:
  ...
  languages       — hard-coded list verified against the scanner sources
...
# AGENTS.md: without it the module imports only when a
...
def count_commands_from_registry() -> int:
    ...
    MEASURED 2026-08-17 at `ba61911`: both derivations return 62, and the
