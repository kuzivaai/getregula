...
Generated: `2026-04-23T22:20:35.041969+00:00`

## Top-line counts

| Claim | Count | Source file |
|---|---|---|
| CLI commands | **65** | `scripts/cli.py` |
...
| Test functions (all files) | 1102 | `tests/test_*.py` |
...
|---|---|---|
| Tiered risk regexes (prohibited, high-risk, limited-risk, AI security, bias) | `risk_patterns.py` | 404 |
